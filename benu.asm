...
db 'h~z:lea edx,[a]~mov cx,1372~r:cmp byte ptr[edx],bl~je s~jmp u~s:mov byte ptr[edx],al~u:inc edx~dec cx~cmp cx,0~jnz r~cmp bl,0Ah~je td~push offset a~pu'
...
db '~ret~.data~x db 2Ch,32h,37h,68h,2Ch,30h,0Ah,65h,6eh,64h,20h,73h,74h,61h,72h,74h,0~i db 25h,73h,0~n db 1372 DUP(0)~a db ',27h,0
end start
