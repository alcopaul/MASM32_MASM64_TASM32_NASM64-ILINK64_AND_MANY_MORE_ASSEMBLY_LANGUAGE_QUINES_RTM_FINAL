...
db ' printf_section .text_main:sub rsp,28h_mov al,0Ah_mov bl,5Fh_z:lea r9,[a]_mov dx,1370_r:cmp byte[r9],bl_je s_jmp u_s:mov byte[r9],al_u:inc r9_dec dx_c'
...
db 'd rsp,28h_ret_section .data_b db 27h,0Dh,0Ah,64h,62h,20h,27h,0_x db 2Ch,32h,37h,68h,2Ch,30h,0_i db 25h,73h,0_n db 1370 DUP(0)_a db ',27h,0